...
The **Museum With No Frontiers — Toys and Games** gallery, built from the published
dataset `@museumwnf/toys-games-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/toys-games-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/toys-games/> through the reusable workflows in
