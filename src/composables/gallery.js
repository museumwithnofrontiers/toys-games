...
// `useGalleryData.js` used to be byte-identical local copies of what toys-games
...
// legacy project key, no UUID — toys-games shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (toys-games-data 1.0.11+), an outside
