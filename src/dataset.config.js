...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'Toys and Games',
  ...
  // one entry for every project id `npm pack @museumwnf/toys-games-data`
  // carries in `manifest.projects` (checked 2026-09-19, toys-games-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/toys-games' },
