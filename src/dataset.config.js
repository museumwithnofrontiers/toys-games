...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'toys-games',
  ...
  home: {
    title: 'toysGames.identity.title',
    intro: 'toysGames.home.intro',
    cards: [
      {
        title: 'toysGames.nav.catalogue',
        description: 'toysGames.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'toysGames.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'toysGames.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'toysGames.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'toysGames.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'toysGames.partnerObjects.emptyPartner',
  //         emptyInstitution: 'toysGames.partnerObjects.emptyInstitution',
  //         institutionSummary: 'toysGames.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'toysGames.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'toysGames.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
